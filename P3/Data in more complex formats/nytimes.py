...
API_KEY = { "popular": "a2f17fa5efc34500a9b6fa5f6e206343",
            "article": "a2f17fa5efc34500a9b6fa5f6e206343"}
...
def article_overview(kind, period):
    ...
    for article in data:
        temp_dict = {}
        temp_dict[article['section']] = article['title']
        titles.append(temp_dict)
        for dt0 in article['media']:
            for dt1 in dt0["media-metadata"]:
                if dt1['format'] == 'Standard Thumbnail':
                    urls.append(dt1['url'])
